...
riscv32-unknown-elf-gcc -Os -o 08.elf start.s main.c -nostartfiles -Wl,-Tlinker.ld -nostdlib -specs=nano.specs -lc_nano
echo ""
riscv32-unknown-elf-size 08.elf
...
python3 elf2uf2.py 08.elf -o 08.uf2 -vv
